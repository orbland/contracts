...
import {EnglishAuctionDelegation} from "../delegation/EnglishAuctionDelegation.sol";

/// @title   English Auction Delegation Test Upgrade
/// @dev     Test Upgrade adds a new storage variable `number`, settable with `setNumber`
contract EnglishAuctionDelegationTestUpgrade is EnglishAuctionDelegation {
    /// Orbs version.
